...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Sign up free and your stack follows you — phone, tablet, or browser, always up to date, no manual refresh.',
  },
  {
    icon: Flame,
    title: 'Recap & streaks',
  ...
  },
  {
    ...
    body: 'Soft gradients, rounded corners, zero clutter — Stack stays out of your way even with fifteen tasks on screen.',
  },
];
      ...
      <section className={styles.hero}>
        ...
        >
          ...
          <p className={styles.subheadline}>
            A calm place for your to-dos — solo, or with the people you share life with. No due
      ...
      <section className={styles.closing}>
        ...
        >
          ...
          <p className={styles.closingBody}>
            No credit card, no busywork to set up. Just a stack, waiting for today's list.
          </p>
          <PrimaryButton as={Link} to="/signup" title="Get started free" variant="solid" />
        </motion.div>
      </section>
